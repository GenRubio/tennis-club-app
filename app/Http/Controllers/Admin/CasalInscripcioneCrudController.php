...
/**
 * Class CasalInscripcioneCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class CasalInscripcioneCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        CRUD::setRoute(config('backpack.base.route_prefix') . '/casalinscripcione');

        $this->crud->addClause('where', 'validado', 0);

        CRUD::setEntityNameStrings('inscripcion', 'Inscripciones casal');
    }
