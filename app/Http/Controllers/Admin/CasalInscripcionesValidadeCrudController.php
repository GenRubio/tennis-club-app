...
/**
 * Class CasalInscripcionesValidadeCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class CasalInscripcionesValidadeCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        CRUD::setRoute(config('backpack.base.route_prefix') . '/casalinscripcionesvalidade');

        $this->crud->addClause('where', 'validado', 1);

        CRUD::setEntityNameStrings('inscripcion', 'Alumnos inscritos');
    }
