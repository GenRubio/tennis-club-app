...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-05-2021 a las 17:49:30
...
(10, 'ESCOLA INFANTIL TENNIS', '<p>MATRICULA: 20&euro; AL COMEN&Ccedil;AR EL CURS / GERMANS -10%</p>', NULL, 'escola-infantil-tennis', 2, 0, 1, 0, 0, '2021-05-05 02:52:55', '2021-05-04 16:01:03'),
(11, 'ESCOLA ADULTS TENNIS', '<p>MAX. 4 ALUMNES</p>', NULL, 'escola-adults-tennis', 3, 0, 1, 0, 0, '2021-05-05 02:52:54', '2021-05-04 16:03:05'),
(12, 'ESCOLA INFANTIL PADEL', '<p>MATRICULA: 20&euro; AL COMEN&Ccedil;AR EL CURS / GERMANS -10%</p>', NULL, 'escola-infantil-padel', 2, 0, 1, 0, 0, '2021-05-05 02:52:54', '2021-05-04 16:03:39'),
(13, 'ESCOLA ADULTS PADEL', '<p>MAX. 4 ALUMNES</p>', NULL, 'escola-adults-padel', 3, 0, 1, 0, 0, '2021-05-05 02:52:53', '2021-05-04 16:04:02'),
(17, 'CASAL D\'ESTIU 2021', NULL, NULL, 'casal-destiu-2021', 1, 0, 2, 0, 0, '2021-05-05 13:06:24', '2021-05-04 16:51:18');
...
(10, 'Preparació física – 1 dia a la setmana 10€/MES', 1, 10, NULL, '2021-05-04 16:31:28', '2021-05-04 16:31:28');
...
--
-- Estructura de tabla para la tabla `actividad_extra_actividad_form_multiple`
--

CREATE TABLE `actividad_extra_actividad_form_multiple` (
  `id` int(11) NOT NULL,
  `actividad_form_multiple_id` int(11) NOT NULL,
  `actividad_extra_id` int(11) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `actividad_extra_actividad_form_simple`
--

CREATE TABLE `actividad_extra_actividad_form_simple` (
  `id` int(11) NOT NULL,
  `actividad_form_simple_id` int(11) NOT NULL,
  `actividad_extra_id` int(11) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Volcado de datos para la tabla `actividad_extra_actividad_form_simple`
--

INSERT INTO `actividad_extra_actividad_form_simple` (`id`, `actividad_form_simple_id`, `actividad_extra_id`, `created_at`, `updated_at`) VALUES
(1, 10, 10, NULL, NULL),
(2, 5, 10, NULL, NULL);
...
--
-- Estructura de tabla para la tabla `actividad_form_multiples`
--

CREATE TABLE `actividad_form_multiples` (
  `id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `actividad_form_multiples`
--

INSERT INTO `actividad_form_multiples` (`id`, `actividad_id`, `titulo`, `descripcion`, `activo`, `created_at`, `updated_at`) VALUES
(2, 17, 'JUNY - JULIOL', NULL, 1, '2021-05-05 13:08:36', '2021-05-05 13:26:37'),
(3, 17, 'AGOST - SETEMBRE', NULL, 1, '2021-05-05 13:08:50', '2021-05-05 13:26:37');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `actividad_form_simples`
--

CREATE TABLE `actividad_form_simples` (
  `id` int(11) NOT NULL,
  `actividad_id` int(11) NOT NULL,
  `titulo` varchar(255) NOT NULL,
  `descripcion` varchar(255) DEFAULT NULL,
...
--
-- Volcado de datos para la tabla `actividad_form_simples`
--

INSERT INTO `actividad_form_simples` (`id`, `actividad_id`, `titulo`, `descripcion`, `activo`, `created_at`, `updated_at`) VALUES
(1, 10, 'INICIACIÓ', '(1h/classe) ENTRE 8-12 ALUMNES', 1, '2021-05-04 17:33:51', '2021-05-05 03:03:17'),
(4, 10, 'PERFECCIONAMENT', '(1.5h/classe) MÀXIM 6 ALUMNES', 1, '2021-05-04 17:51:26', '2021-05-05 03:03:17'),
(5, 10, 'COMPETICIÓ', '(2h/classe) MÀXIM 4 ALUMNES', 1, '2021-05-04 17:51:44', '2021-05-05 03:03:16'),
(6, 11, 'CLASSES MENSUALS', NULL, 1, '2021-05-04 17:54:11', '2021-05-05 03:03:16'),
(7, 11, 'CLASSES PARTICULARS', NULL, 1, '2021-05-04 17:54:21', '2021-05-05 03:03:15'),
(8, 12, 'INICIACIÓ', '(1h/classe) MÀXIM 6 ALUMNES', 1, '2021-05-04 17:54:51', '2021-05-05 03:03:15'),
(9, 12, 'PERFECCIONAMENT', '(1.5h/classe) MÀXIM 4 ALUMNES', 1, '2021-05-04 17:55:05', '2021-05-05 03:03:14'),
(10, 12, 'COMPETICIÓ', '(2h/classe) MÀXIM 4 ALUMNES', 1, '2021-05-04 17:55:21', '2021-05-05 03:03:14'),
(11, 13, 'CLASSES MENSUALS', NULL, 1, '2021-05-04 17:55:35', '2021-05-05 03:03:13'),
(12, 13, 'CLASSES PARTICULARS', NULL, 1, '2021-05-04 17:55:48', '2021-05-05 03:03:13');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `actividad_horarios`
--

CREATE TABLE `actividad_horarios` (
  `id` int(11) NOT NULL,
  `calendario_actividad_id` int(11) NOT NULL,
...
--
-- Estructura de tabla para la tabla `actividad_horas`
--

CREATE TABLE `actividad_horas` (
  `id` int(11) NOT NULL,
  `actividad_horario_id` int(11) NOT NULL,
  `dia_inico` int(11) NOT NULL,
...
(1, 'Casal', '2021-04-25 06:16:01', '2021-04-25 06:16:01'),
(2, 'Escuela infantil', '2021-04-25 06:16:06', '2021-05-04 15:38:14'),
(3, 'Escuela adultos', '2021-04-25 06:16:12', '2021-05-04 16:04:36'),
(4, 'Otros', '2021-04-25 06:16:24', '2021-04-25 06:16:24');
...
(26, 64, 'Eugeny', 'Lyubeznyy', 0, 'Y1774178H', 'Barbados', NULL, '17310', 'LLoret de mar', 17310, 'Girona', '1998-02-13', NULL, '32423434', NULL, NULL, NULL, NULL, NULL, 'images/profile/fea234d18e8dca2e27dcf3ca52ba0b98.jpg', NULL, '2021-04-29 02:39:37'),
(27, 64, 'Mohamed', 'Alibaba', 0, NULL, 'Albania', '235235345345', '17310', 'LLoret de mar', 17310, 'Girona', '2009-02-13', NULL, NULL, NULL, 'Eugeny', '32423434', NULL, NULL, NULL, NULL, '2021-04-30 17:43:03');
...
--
-- Estructura de tabla para la tabla `form_multiple_respuestas`
--

CREATE TABLE `form_multiple_respuestas` (
  `id` int(11) NOT NULL,
  `actividad_form_multiple_id` int(11) NOT NULL,
  `titulo` varchar(255) NOT NULL,
  `activo` tinyint(1) NOT NULL DEFAULT 0,
...
--
-- Volcado de datos para la tabla `form_multiple_respuestas`
--

INSERT INTO `form_multiple_respuestas` (`id`, `actividad_form_multiple_id`, `titulo`, `activo`, `precio_normal`, `precio_socio`, `created_at`, `updated_at`) VALUES
(1, 2, '23 de Juny', 1, NULL, NULL, '2021-05-05 13:24:46', '2021-05-05 13:24:46'),
(2, 2, '25 de juny', 1, NULL, NULL, '2021-05-05 13:24:54', '2021-05-05 13:24:54'),
(3, 2, '28 de juny al 2 de juliol', 1, NULL, NULL, '2021-05-05 13:25:10', '2021-05-05 13:25:10'),
(4, 2, '5 de juliol al 9 de juliol', 1, NULL, NULL, '2021-05-05 13:25:16', '2021-05-05 13:25:16'),
(5, 2, '12 de juliol al 16 de juliol', 1, NULL, NULL, '2021-05-05 13:25:21', '2021-05-05 13:25:21'),
(6, 2, '19 de juliol al 23 de juliol', 1, NULL, NULL, '2021-05-05 13:25:29', '2021-05-05 13:25:29'),
(7, 2, '26 de juliol al 30 de juliol (festa 26 juliol)', 1, NULL, NULL, '2021-05-05 13:25:34', '2021-05-05 13:25:34'),
(8, 3, '2 d\'agost al 6 d\'agost', 1, NULL, NULL, '2021-05-05 13:26:00', '2021-05-05 13:26:00'),
(9, 3, '9 d\'agost al 13 d\'agost (festa 15 agost)', 1, NULL, NULL, '2021-05-05 13:26:05', '2021-05-05 13:26:05'),
(10, 3, '16 d\'agost al 20 d\'agost', 1, NULL, NULL, '2021-05-05 13:26:10', '2021-05-05 13:26:10'),
(11, 3, '23 d\'agost al 27 d\'agost', 1, NULL, NULL, '2021-05-05 13:26:19', '2021-05-05 13:26:19'),
(12, 3, '30 d` agost al 3 de setembre', 1, NULL, NULL, '2021-05-05 13:26:27', '2021-05-05 13:26:27'),
(13, 3, '6 de setembre al 10 setembre (festa 11 set)', 1, NULL, NULL, '2021-05-05 13:26:31', '2021-05-05 13:26:31');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `form_simple_respuestas`
--

CREATE TABLE `form_simple_respuestas` (
  `id` int(11) NOT NULL,
  `actividad_form_simple_id` int(11) NOT NULL,
  `titulo` varchar(255) NOT NULL,
  `activo` tinyint(1) NOT NULL DEFAULT 0,
...
--
-- Volcado de datos para la tabla `form_simple_respuestas`
--

INSERT INTO `form_simple_respuestas` (`id`, `actividad_form_simple_id`, `titulo`, `activo`, `precio_normal`, `precio_socio`, `created_at`, `updated_at`) VALUES
(3, 12, '1H', 1, 30, 18, '2021-05-04 18:27:04', '2021-05-04 18:27:04'),
(4, 12, '1h / 2 persones', 1, 18, 10.8, '2021-05-04 18:27:44', '2021-05-04 18:27:44'),
(5, 12, '1h / 3 persones', 1, 12, 7.2, '2021-05-04 18:27:59', '2021-05-04 18:27:59'),
(29, 4, '1 DIA A LA SETMANA', 1, 48, 28.2, '2021-05-05 03:02:07', '2021-05-05 03:02:07'),
(30, 4, '2 DIES A LA SETMANA', 1, 76, 45.6, '2021-05-05 03:02:19', '2021-05-05 03:02:19'),
(31, 1, '1h/SETMANA', 1, 25, 15, '2021-05-05 03:02:51', '2021-05-05 03:02:51'),
(32, 1, '2h/SETMANA', 1, 45, 27, '2021-05-05 03:03:03', '2021-05-05 03:03:03');
...
(10, 'keylorubio@gmail.com', '47e3210ec67e75d50b1f73bf5c9b1d6f', 0, '2021-05-01 07:19:08', '2021-05-01 07:19:08');
...
(4, 'FAMILIAR', 65.00, 1, '2021-04-25 13:27:32', '2021-04-17 10:11:17'),
(5, 'INDIVIDUAL', 45.00, 1, '2021-04-25 13:27:19', '2021-04-17 10:13:09'),
(6, 'INDIVISUAL PÀDEL', 35.00, 1, '2021-04-25 13:27:00', '2021-04-17 10:14:33'),
(7, 'INDIVIDUAL TENNIS', 35.00, 1, '2021-04-25 13:26:39', '2021-04-17 10:15:22'),
(8, 'INFANTIL', 35.00, 1, '2021-04-25 13:26:22', '2021-04-17 10:16:05');
...
(64, 'keylorubio@gmail.com', NULL, NULL, 1, '', NULL, 0, 'NCbXmtC6qayE6iyYXcP0RrJD4TzhS5Uy7iEW5KDuRr9GXttx5blXPjVyb9xa', '$2y$10$F6GGEfS3n.v2h2S6xaO/Y./EJ6Xdfq7.uLezYeMLsb.Gzv2Ebz9yu', 2, 1, '2021-04-03 09:03:10', '2021-04-28 14:28:05'),
...
--
-- Indices de la tabla `actividad_extra_actividad_form_multiple`
--
ALTER TABLE `actividad_extra_actividad_form_multiple`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `actividad_extra_actividad_form_simple`
--
ALTER TABLE `actividad_extra_actividad_form_simple`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `actividad_form_multiples`
--
ALTER TABLE `actividad_form_multiples`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `actividad_form_simples`
--
ALTER TABLE `actividad_form_simples`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `actividad_horarios`
--
ALTER TABLE `actividad_horarios`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `actividad_horas`
--
ALTER TABLE `actividad_horas`
  ADD PRIMARY KEY (`id`);
...
--
-- Indices de la tabla `form_multiple_respuestas`
--
ALTER TABLE `form_multiple_respuestas`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `form_simple_respuestas`
--
ALTER TABLE `form_simple_respuestas`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT de la tabla `actividad_extra_actividad_form_multiple`
--
ALTER TABLE `actividad_extra_actividad_form_multiple`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `actividad_extra_actividad_form_simple`
--
ALTER TABLE `actividad_extra_actividad_form_simple`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `actividad_form_multiples`
--
ALTER TABLE `actividad_form_multiples`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de la tabla `actividad_form_simples`
--
ALTER TABLE `actividad_form_simples`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT de la tabla `actividad_horarios`
--
ALTER TABLE `actividad_horarios`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `actividad_horas`
--
ALTER TABLE `actividad_horas`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `form_multiple_respuestas`
--
ALTER TABLE `form_multiple_respuestas`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT de la tabla `form_simple_respuestas`
--
ALTER TABLE `form_simple_respuestas`
