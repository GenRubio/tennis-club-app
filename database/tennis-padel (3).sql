...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-05-2021 a las 15:21:15
...
CREATE TABLE `actividad_horarios` (
  ...
  `precio_socio` double NOT NULL DEFAULT 0,
  `updated_at` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(2, 'Tennis', '2021-04-25 06:16:06', '2021-04-25 07:37:52'),
(3, 'Padel', '2021-04-25 06:16:12', '2021-04-25 07:37:32'),
